...
export declare const upcomingCertifications: readonly [Certification.FullStackDeveloper, Certification.RespWebDesignV9, Certification.JsV9, Certification.FrontEndDevLibsV9, Certification.PythonV9, Certification.RelationalDbV9, Certification.BackEndDevApisV9, Certification.A2English, Certification.B1English, Certification.A2Spanish, Certification.A2Chinese, Certification.A1Chinese];
export declare const certTypes: {
    ...
    readonly respWebDesignV9: "isRespWebDesignCertV9";
    ...
    readonly javascriptV9: "isJavascriptCertV9";
    readonly a2English: "isA2EnglishCert";
};
export declare const certIds: {
    ...
    respWebDesignV9Id: string;
    javascriptV9Id: string;
    frontEndLibsV9Id: string;
    pythonV9Id: string;
    relationalDbV9Id: string;
    backEndDevApisV9Id: string;
    a2EnglishId: string;
};
export declare const completionHours: {
    ...
    isJavascriptCertV9: number;
    isA2EnglishCert: number;
};
export declare const certSlugTypeMap: {
    ...
    "responsive-web-design-v9": "isRespWebDesignCertV9";
    "javascript-v9": "isJavascriptCertV9";
    "a2-english-for-developers-v8": "isA2EnglishCert";
};
export declare const superBlockCertTypeMap: {
    ...
    "a2-english-for-developers": "isA2EnglishCert";
};
export declare const certTypeIdMap: {
    ...
    isJavascriptCertV9: string;
    isA2EnglishCert: string;
};
